package com.example.aether.export;
...
import com.example.aether.rendering.ObjectModel;
...
public class OBJExport {
    ...
    public static boolean write(ObjectModel objectModel, Bitmap texture, String dirName) {
        ...
        String mtlPath = suffix + "aether_model.mtl";
        String texPath = suffix + "aether_model.jpg";

        try {
            BufferedWriter out = new BufferedWriter(new FileWriter(objPath));
            out.write("# Created by Aether\n");
            out.write("mtllib aether_model.mtl\n");
            ...
            out.write("map_Kd aether_model.jpg\n");
            out.flush();
            out.close();
